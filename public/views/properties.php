    ...
    <article class="listing-container" v-for="prop in properties" v-cloak>
        <div class="listing-row"> <!-- class featured in case of define any way to detect it -->
            <div class="listing-row-image" v-bind:style="prop.thumbnail">
                <a v-bind:href="'<?php echo home_url('/').$atts['propertyPage']; ?>?id='+prop.id_property" class="listing-row-image-link"></a>
            ...
            <div class="listing-row-properties">
                <h3 class="listing-row-title"><a v-bind:href="'<?php echo home_url('/').$atts['propertyPage']; ?>?id='+prop.id_property" >{{prop.title}}</a></h3>
